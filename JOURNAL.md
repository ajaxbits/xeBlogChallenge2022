...
- Deciding to start with the code from Sylvain Kerkour's blog, [Building a static site generator in 100 lines of Rust](https://kerkour.com/rust-static-site-generator), since I'm already familiar with that code.
